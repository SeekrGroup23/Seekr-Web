<template>
  <v-container fluid grid-list-md>
    <v-layout row wrap>
      <v-flex md4 sm4>
        <v-card color="teal accent-4" class="white--text mx-auto" height="150px" max-width="400">
          <v-card-title primary-title class="justify-center">
            <v-icon dark x-large right >person_pin</v-icon>
            <span class="title font-weight-light">Total Count</span>               
          </v-card-title>
          <v-card-title class="justify-center">
            <p class="text-center display-2"><pre>       {{gramaCount}}      </pre></p>
          </v-card-title>
        </v-card>
      </v-flex>
      <v-flex md4 sm4>
              ...
              <v-container style="height: 520px;" id="uForm">
                <v-stepper v-model="e1">
                  <v-stepper-header>
                    ...
                    <v-divider></v-divider>
                    <v-stepper-step :complete="e1 > 2" step="2">Occupational Data</v-stepper-step>
                    <v-divider></v-divider>
                  ...
                  <v-stepper-items>
                    <v-stepper-content step="1">
                      ...
                      <v-btn color="indigo darken-3"  dark @click="e1 = 2"><v-icon>chevron_right</v-icon></v-btn>
                    </v-stepper-content>
                    ...
                    <v-stepper-content step="2">
                      ...
                      <v-btn color="indigo darken-3" @click="e1 = 3" dark><v-icon >chevron_right</v-icon></v-btn>
                      <v-btn color="blue darken-3" text @click="e1 = 1" dark><v-icon>chevron_left</v-icon></v-btn>
                    </v-stepper-content>

                    <v-stepper-content step="3">
                      <v-card class="mb-12" height="50px" flat>
                    
                      </v-card>
                      <v-btn color="blue darken-3" text @click="e1 = 2" dark><v-icon>chevron_left</v-icon></v-btn>
                      <v-btn color="success" v-on:click="submit()">submit</v-btn>
                      <v-btn color="#FF6F00" dark v-on:click="e1 = clear()">Add New</v-btn>
                    </v-stepper-content>
                  </v-stepper-items>
                </v-stepper>
              </v-container>
  ...
  export default {
    ...
    computed: {
      fNameErrors () {
        ...
        !this.$v.grama.fName.minLength && errors.push('Name must be at most 10 characters long')
      ...
      lNameErrors () {
        ...
        !this.$v.grama.lName.minLength && errors.push('Name must be at most 10 characters long')
      ...
      contactErrors(){
        ...
        if (!this.$v.grama.cNumber.$dirty) {
          ...
          !this.$v.grama.cNumber.required && errors.push("Contact Number is required");
          /* !this.isEmailAvailable &&
    ...
    methods: {
      submit(){
        ...
        if(!this.$v.grama.$invalid){
          this.$http.post("/admin/add/grama", {
