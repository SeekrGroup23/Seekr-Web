...
import createpost from "./views/Admin/Information Hub/createpost.vue";
import show_post from "./views/Admin/Information Hub/show_post.vue";
...
import news from "./views/Admin/Information Hub/news.vue"
Vue.use(Router);
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "Information_hub/create_post",
          component: createpost
        },
        {
          path: "Information_hub/show_post",
          component: show_post
        },
        {
          path: "Information_hub/news",
          component: news
        }
      ]
    }
